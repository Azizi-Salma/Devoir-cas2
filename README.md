...
##  Structure du projet
Devoir-cas2/
1. config-server/ # Spring Cloud Config Server (port 8888)
2. eureka-server/ # Service Discovery avec Eureka (port 8761)
3. api-gateway/ # API Gateway (Spring Cloud Gateway, port 8080)
4. microservice-commandes/ # CRUD Commandes + santé personnalisée (port 8082)
5. microservice-produit/ # CRUD Produits (port 8081)
6. config-repo/ # Dépôt Git local des configurations
